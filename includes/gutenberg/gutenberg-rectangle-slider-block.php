...
class Gutenberg_Rectangle_Slider_Block {
    ...
    public static function acf_register_block_type() {
        ...
        acf_register_block_type( [
            'name' => 'rectangle-slider-block',
            'title' => 'Блок з прямокутним слайдером',
            'description' => '',
            'category' => 'custom',
            'icon' => '',
    ...
    public static function acf_register_local_field_group() {
        ...
        if ( function_exists('acf_add_local_field_group') ):
            ...
            acf_add_local_field_group(array(
                'key' => 'group_64a2d9f1ef61f',
                'title' => 'Gutenberg Rectangle Slider Block',
                'fields' => array(
                    array(
                        'key' => 'field_64a2d9f1f0bc6',
                        'label' => 'Slider',
                        'name' => 'slider',
                        'aria-label' => '',
                        'type' => 'repeater',
                        ...
                        'sub_fields' => array(
                            array(
                                ...
                                'mime_types' => '',
                                'preview_size' => 'medium',
                                'parent_repeater' => 'field_64a2d9f1f0bc6',
                            ),
                        ),
                    ),
                ),
                'location' => array(
                    array(
                        array(
                            'param' => 'block',
                            'operator' => '==',
                            'value' => 'acf/rectangle-slider-block',
                        ),
                    ),
                ),
                'menu_order' => 0,
