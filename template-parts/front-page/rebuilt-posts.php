...
class Front_Page_Rebuilt_Posts {
    ...
    public function __construct() {
        ...
        $this->help_term = get_term_by( 'slug', 'rebuilt', 'story_type');
        $this->help_term_link = get_term_link( 'rebuilt', 'story_type' );
            ...
            <section class="main-history">
                <div class="container">
                    <div class="main-history__wrapper">
                        ...
                        <div class="slider-history swiper slider-22" id="slider-22">
                            ...
                            <div class="swiper-pagination slider-22__swiper-pagination "></div>
                        </div>
                        <div class="history-button">
                            <a href="<?php echo $this->help_term_link; ?>" class="button-primary button-secondary">
                                <p class="text-button-bold">всі об’єкти</p>
                            </a>
                        </div>
                    </div>
                </div>
