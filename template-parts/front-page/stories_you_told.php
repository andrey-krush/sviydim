...
class Front_Page_Stories_You_Told {
    ...
    public function __construct() {
        ...
        $this->help_term = get_term_by( 'slug', 'stories', 'story_type');
        $this->help_term_link = get_term_link( 'stories', 'story_type' );
            ...
            <section class="main-history">
                <div class="container">
                    <div class="main-history__wrapper">
                        ...
                        <div class="slider-history swiper slider-23" id="slider-23">
                            ...
                            <div class="swiper-pagination slider-23__swiper-pagination "></div>
                        </div>
                        <div class="history-button">
                            <a href="<?php echo $this->help_term_link; ?>" class="button-primary button-secondary">
                                <p class="text-button-bold">всі історії</p>
                            </a>
                        </div>
                    </div>
                </div>
