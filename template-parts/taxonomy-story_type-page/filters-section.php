...
class Taxonomy_Story_Page_Filters_Section {
    ...
    public function __construct() {
        ...
        $this->term_link = get_term_link($this->term, 'story_type');
        ...
        $this->top_posts = get_field('top_posts', 'story_type_' . $this->term->term_id );
        $this->form_title = get_field('form_title', 'story_type_' . $this->term->term_id );
        $this->form_button = get_field('form_button', 'story_type_' . $this->term->term_id );
